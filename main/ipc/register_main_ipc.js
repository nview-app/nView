...
const MODULE_CHANNEL_ALLOWED_ROLES = Object.freeze({
  ...
  groups: Object.freeze({
    "groups:list": ["gallery", "group-manager", "reader"],
    "groups:get": ["gallery", "group-manager", "reader"],
    "groups:create": ["gallery", "group-manager", "reader"],
    "groups:update-meta": ["gallery", "group-manager", "reader"],
    "groups:update-membership": ["gallery", "group-manager", "reader"],
    "groups:delete": ["gallery", "group-manager", "reader"],
    "groups:resolve-for-reader": ["gallery", "group-manager", "reader"],
  }),
